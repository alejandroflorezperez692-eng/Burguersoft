<?php
  ...
  $stmt = $pdo->prepare("
    SELECT 
        ...
        ve.tipo_entrega    AS tipo_entrega,
...
foreach ($filas as $f) {
    ...
    if (!isset($pedidos[$vid])) {
        $pedidos[$vid] = [
            ...
            'tipo_entrega' => $f['tipo_entrega'] ?? 'Recoger',
            'items'        => [],
            'total'        => 0,
        ];
    }
    ...
    <div class="pedidos-page">
        ...
        <?php if (empty($pedidos)): ?>
            ...
            <?php else: ?>
                ...
                switch ($p['tipo_entrega']) {
                    case 'Domicilio': $pasos = $pasos_domicilio; break;
                    case 'Recoger':   $pasos = $pasos_recoger;   break;
                    default:          $pasos = $pasos_consumir;  break;
                }
                ...
                $halfStep   = 50 / $totalPasos;
                $fillWidth  = $cancelado ? 0 : round(($paso_actual / $totalPasos) * 100, 2);
            ...
            <div class="pedido-card">
                ...
                <div class="progreso-container">
                    ...
                    <div class="progreso-barra-wrapper">
                        <div class="progreso-linea-bg" style="left:<?= $halfStep ?>%; right:<?= $halfStep ?>%;"></div>
                        <div class="progreso-linea-fill" style="left:<?= $halfStep ?>%; width:<?= $fillWidth ?>%;"></div>
